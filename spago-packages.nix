...
let
  inputs = {
    ...
    "graphql" = pkgs.stdenv.mkDerivation {
        name = "graphql";
        version = "v1.0.1";
        src = pkgs.fetchgit {
          url = "https://github.com/hendrikniemann/purescript-graphql.git";
          rev = "69eb71521269a26d140b0d8910212ce8c89cab48";
          sha256 = "1z1c5i1s3nc2bs258i9yak1sgwdbchzfwwy1wzakyxg81g6zqgld";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "slug" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "51b5ce3f98105f8dd0d49390597517161797b455";
